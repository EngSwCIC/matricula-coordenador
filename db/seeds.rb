...
if !Rails.env.production?
  ...
  About.create(
    description:"
      Este é um projeto que visa a automação do processo de matrícula feito pelo coordenador para as disciplinas que precisam de um requerimento de matrícula.
